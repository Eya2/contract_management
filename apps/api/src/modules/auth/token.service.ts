...
export function refreshTokenExpiry(persistent: boolean, from = new Date()): Date {
  const ms = persistent ? env.REFRESH_TOKEN_TTL_DAYS * 24 * 60 * 60 * 1000 : env.SESSION_TTL_HOURS * 60 * 60 * 1000;
