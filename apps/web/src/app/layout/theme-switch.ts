...
@Component({
  ...
  imports: [TPipe, MatIconModule, MatTooltipModule],
  template: `
    <div class="grid grid-cols-3 gap-1 rounded-xl bg-subtle p-1" role="radiogroup" [attr.aria-label]="'Color theme' | t">
      @for (o of options; track o.value) {
        <button
          type="button"
          role="radio"
          [attr.aria-checked]="theme.preference() === o.value"
          [matTooltip]="o.label | t"
          [attr.aria-label]="o.label | t"
